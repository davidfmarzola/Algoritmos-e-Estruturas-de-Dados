...
class SeriesSelectionSort {
    ...
    public SeriesSelectionSort(String nome, String formato, String duracao, String paisDeOrigem, String idiomaOriginal,
    ...
    public static SeriesSelectionSort lerAtributo(String endereco) {
        SeriesSelectionSort s1 = new SeriesSelectionSort();
    ...
    public static void imprimir(SeriesSelectionSort s1) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SeriesSelectionSort vetorObjetoSeries[] = new SeriesSelectionSort[61];
...
class Lista {
    ...
    SeriesSelectionSort[] vetorObjetoSeries;
    int indice;
    ...
    Lista(int tamanho) {
        vetorObjetoSeries = new SeriesSelectionSort[tamanho];
        indice = 0;
    }

    void swap(int a, int b) {
        SeriesSelectionSort temp = vetorObjetoSeries[a];
        vetorObjetoSeries[a] = vetorObjetoSeries[b];
        vetorObjetoSeries[b] = temp;
    }

    void selectionSort(int indice) {
        Long tempoInicial = System.currentTimeMillis();
        int numeroComparacoes = 0;
        int numeroMovimentacoes = indice - 1 * 3;

        for (int i = 0; i < (indice - 1); i++) {
            int menor = i;
            for (int j = (i + 1); j < indice; j++) {
                // primeira string maior do que a segunda
                if (vetorObjetoSeries[menor].getPaisDeOrigem().compareTo(vetorObjetoSeries[j].getPaisDeOrigem()) > 0) {
                    menor = j;
                    numeroComparacoes++;
                } else if (vetorObjetoSeries[menor].getPaisDeOrigem()
                        .compareTo(vetorObjetoSeries[j].getPaisDeOrigem()) == 0) {
                    numeroComparacoes++;
                    if (vetorObjetoSeries[menor].getNome().compareTo(vetorObjetoSeries[j].getNome()) > 0) {
                        menor = j;
                        numeroComparacoes++;
                    }
                }
    ...
    void inserirFim(SeriesSelectionSort serie) throws Exception {
    ...
    void arquivoLog(Long tempoExecucao, int numeroComparacoes, int numeroMovimentacoes) {
        ...
        Arq.print("712325\t");
        Arq.print(tempoExecucao + " milissegundos\t");
