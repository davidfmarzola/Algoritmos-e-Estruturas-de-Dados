...
class SeriesQuickSort {
    ...
    public SeriesQuickSort(String nome, String formato, String duracao, String paisDeOrigem, String idiomaOriginal,
    ...
    public static SeriesQuickSort lerAtributo(String endereco) {
        SeriesQuickSort s1 = new SeriesQuickSort();
    ...
    public static void imprimir(SeriesQuickSort s1) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SeriesQuickSort vetorObjetoSeries[] = new SeriesQuickSort[61];
...
class Lista {
    ...
    SeriesQuickSort[] vetorObjetoSeries;
    int indice;
    ...
    Lista(int tamanho) {
        vetorObjetoSeries = new SeriesQuickSort[tamanho];
        indice = 0;
        numeroComparacoes = 0;
    ...
    void swap(int a, int b) {
        SeriesQuickSort temp = vetorObjetoSeries[a];
    ...
    void quicksort(int esq, int dir) {
        int i = esq, j = dir;
        SeriesQuickSort pivo = vetorObjetoSeries[(esq + dir) / 2];
        Long tempoInicial = System.currentTimeMillis();
        while (i <= j) {
            while (((vetorObjetoSeries[i].getPaisDeOrigem().compareTo(pivo.getPaisDeOrigem()) < 0)
                    || (vetorObjetoSeries[i].getPaisDeOrigem().compareTo(pivo.getPaisDeOrigem()) == 0
                            && vetorObjetoSeries[i].getNome().compareTo(pivo.getNome()) < 0))) {
                numeroComparacoes += 3;
                i++;
            }
            while (((vetorObjetoSeries[j].getPaisDeOrigem().compareTo(pivo.getPaisDeOrigem()) > 0)
                    || (vetorObjetoSeries[j].getPaisDeOrigem().compareTo(pivo.getPaisDeOrigem()) == 0
                            && vetorObjetoSeries[j].getNome().compareTo(pivo.getNome()) > 0))) {
                numeroComparacoes += 3;
                j--;
            }
            if (i <= j) {
    ...
    void inserirFim(SeriesQuickSort serie) throws Exception {
